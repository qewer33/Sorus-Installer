...
public class CreateProfilePanel extends BasePanel {
  ...
  private final JTextField mappingsSelection;
  ...
  public CreateProfilePanel(String minecraftPath) {
    ...
    mappingsSelection = new JTextField();
  ...
  private void install(ActionEvent e) {
    ...
    try {
      ...
      String mappings = mappingsSelection.getText();
      ...
      installation.javaArgs =
          "-Xmx"
              ...
              + ".jar=version="
              + version
              + (!mappings.isEmpty() ? ";mappings=" + mappingsSelection.getText() : "");
      launcherProfiles.profiles.put(this.generateRandomString(8), installation);
              ...
              () -> {
                ...
                try {
                  this.downloadIfDifferent(
                      new URL(
                          "https://github.com/SorusClient/Sorus-Resources/raw/master/client/"
                              + version
                              + ".jar"),
                    ...
                    this.downloadIfDifferent(
                        new URL(
                            "https://github.com/SorusClient/Sorus-Resources/raw/master/mappings/"
                                + mappings
                                + ".txt"),
                        new File(minecraftPath + "/sorus/mappings/" + mappings + ".txt"));
                  }
                } catch (IOException ex) {
                  ex.printStackTrace();
                }
  ...
  public String generateRandomString(int length) {
    ...
    for (int i = 0; i < length; i++) {
      String DATA_FOR_RANDOM_STRING = "ABCDEFGHIJKLMNOPQRSTUVWXYZ09123456789";
